...
export default function HistoryPage() {
  ...
  const history = role === "doctor" ? doctorHistory : patientHistory;

  return (
    <ProtectedRoute>
      <DashboardLayout
        title={role === "doctor" ? "Patient History" : "Medical History"}
      >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-lg font-bold text-black">
                        {role === "doctor"
                          ? (item as DoctorHistory).patient
                          : (item as PatientHistory).doctor}
                      </h3>
